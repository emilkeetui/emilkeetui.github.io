...
Keep the file names exactly as above, or update the references in the `.qmd`
files / `_quarto.yml` to match your names.

You can delete this README once everything is in place.
